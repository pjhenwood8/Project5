                ...
                if (choice == 0) {       // MESSAGES / STATISTICS / ACCOUNT / EXIT
                    if (user instanceof Buyer) {
                        ...
                        if (choice == 0) {      //WRITE TO STORE / WRITE TO SELLER / EXIT
                            ...
                            oos.flush();
                            String storeNameToMessage = in.readLine();       // user enters the name of the store
                            String message = in.readLine();                  // and the message itself also
...
//                                                                                     // he can text to
                                    ...
                                    String sellerToWrite = in.readLine();      // we ask him to write one
                                    // seller name
                                        ...
                                        if (optionChoice == 0) {                             //if user
                                            ...
                                            if (fileOrText == 0) {              // if user sends regular message
                                                ...
                                                try {
                                                    ...
                                                    out.write("I'm sorry but that file does not exist");
                                                    out.println();
                                                    out.flush();
                                                }
                                            }
...
//                                        System.out.println("Enter name of user:");
                                String newUser = in.readLine();         // Enter name of the new user
                                ...
                                for (String u : listOfUsers) {
                                    if (u.equals(newUser)) {
                                        ...
                                        out.write("You already messaged this user");
                                        out.println();
                                        out.flush();
                                    }
                                }
                                ...
                                for (User value : allUsers) {
                                    if (value.getUsername().equals(newUser)) {
                                        ...
                                        if (value instanceof Seller) {
                                            out.write("You can't write to Seller, because you are Seller " +
                                                    "yourself");
                                            out.println();
                                            out.flush();
                                            ...
                                            out.write("You can't write to this user because they are blocked");
                                            out.println();
                                            out.flush();
                                ...
                                if (flag1) {     // if flag1 is true, user does NOT exist
                                    ...
                                    String mes = in.readLine();               // user enters the message he would
...
//                                            System.out.println("[-1] Export this message history to csv file");
                                    ...
                                    int optionChoice = in.read();            // enters which
...
//                                                System.out.println("Enter name of the file to which you want to export your message history");
                                        String fileName = in.readLine();            // enters the file name
                                        PrintWriter pw = new PrintWriter(new FileOutputStream(fileName, false));
                                        for (Message msg : messageHistory) {
...
//                                                System.out.println();
                                    ...
                                    if (optionChoice == 1) {            // writing new messages
                                        ...
                                        if (fileOrText == 1) {       // regular message
                                            ...
                                            //System.out.println("Enter name of txt file: ");
                                            String fileName = in.readLine();         // enters name of the file
                                            String mes;
                                            try {
                                                ArrayList<String> tempArr = new ArrayList<>();
                                                BufferedReader bfr = new BufferedReader(new FileReader(fileName));
                                    ...
                                    if (optionChoice == 2) {          // editing messages
                                        ...
                                        //System.out.println("Choose message to edit");
                                        choice = in.read();           // user chooses which
                                        // message
                                        // available for him to edit he wants to edit
                                        //System.out.println("To which message you want to change it?");
                                        String msg = in.readLine();                   // user enters the message
                                        // to
                    ...
                    while (true) {
                        ...
                        if (alphabetical == 0) {
                            if (user instanceof Buyer) {
                                ...
                                out.write(sortMessages.toString());
                                out.println();
                                out.flush();
                            }
                    ...
                    while (true) {
                        ...
                        if (choice == 0) {
                            ...
                            out.write(blockedUsers.toString());
                            out.println();
                            out.flush();
                            ...
                            switch (choice) {
                                ...
                                case 1:
                                    ...
                                    if (blockedUsersArr.length > 0) {
                                        String unblockUsername = in.readLine();
